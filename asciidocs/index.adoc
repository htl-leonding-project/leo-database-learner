...
https://htl-leonding-project.github.io/leo-database-learner/howtodatabase.html[*How to get the Postgres DB*,role=black] +
https://htl-leonding-project.github.io/leo-database-learner/howtooracledatabase.html[*How to get the Oracle DB*,role=black] +
