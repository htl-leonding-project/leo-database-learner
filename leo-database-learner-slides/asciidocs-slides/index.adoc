...
video::promotion.mp4[Promitionvideo]
...
* https://primetzvan.github.io/hugo-project/[Hugo page Primetzhofer]
* https://chrissyraffeiner.github.io/hugo-project/[Hugo page Raffeiner]
